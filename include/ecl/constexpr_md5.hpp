...
{
    return ((static_cast<uint32_t>(data[n * 4 + 0]) << 0)  & 0x000000ff) | 
           ((static_cast<uint32_t>(data[n * 4 + 1]) << 8)  & 0x0000ff00) | 
           ((static_cast<uint32_t>(data[n * 4 + 2]) << 16) & 0x00ff0000) | 
...
constexpr md5_type make_md5_result(uint32_t a, uint32_t b, uint32_t c, uint32_t d) 
{
    ...
    return md5_type {
        { 
            static_cast<value_type>( a & 0x000000ff),        
            static_cast<value_type>((a & 0x0000ff00) >> 8), 
            static_cast<value_type>((a & 0x00ff0000) >> 16), 
            static_cast<value_type>((a & 0xff000000) >> 24),

            static_cast<value_type>( b & 0x000000ff),        
            static_cast<value_type>((b & 0x0000ff00) >> 8), 
            static_cast<value_type>((b & 0x00ff0000) >> 16), 
            static_cast<value_type>((b & 0xff000000) >> 24),

            static_cast<value_type>( c & 0x000000ff),        
            static_cast<value_type>((c & 0x0000ff00) >> 8), 
            static_cast<value_type>((c & 0x00ff0000) >> 16), 
            static_cast<value_type>((c & 0xff000000) >> 24),

            static_cast<value_type>( d & 0x000000ff),        
            static_cast<value_type>((d & 0x0000ff00) >> 8), 
            static_cast<value_type>((d & 0x00ff0000) >> 16),
...
// constexpr md5_type operator "" _md5(const char* const data, constexpr size_t size)
// {
//     return md5<size>(data);
// }
