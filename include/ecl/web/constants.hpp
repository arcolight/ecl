...
static inline str_const to_string(status_code c)                        noexcept
{
    switch(c)
    {
...
static inline str_const to_string(method m)                             noexcept
{
    switch(m)
    {
...
static inline str_const to_string(header_name n)                        noexcept
{
    switch(n)
    {
...
static inline str_const to_string(content_type t)                       noexcept
{
    switch(t)
    {
...
static inline str_const to_string(content_encoding e)                   noexcept
{
    switch(e)
    {
